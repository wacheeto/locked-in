...
const Navbar = () => {
  return (
    <div className="navbar bg-black shadow-sm h-[80px] md:px-8 text-white sticky top-0 z-50">
        <div className="flex-1">
            <a className="font-bold text-xl text-green-500">LockedIn</a>
        </div>
                ...
                <li className="flex items-center justify-center md:hidden">
                    <details className="relative text-white">
                        ...
                        <ul className="absolute right-0 mt-4 w-40 bg-zinc-950 rounded-md shadow-lg p-2 space-y-1 z-50">
                            <li>
                                <a className="block px-3 py-2 hover:bg-zinc-800 rounded-md">Home</a>
                            </li>
                            <li>
                                <a className="block px-3 py-2 hover:bg-zinc-800 rounded-md">Services</a>
                            </li>
                            <li>
                                <a className="block px-3 py-2 hover:bg-zinc-800 rounded-md">About</a>
                            </li>
                            <li>
                                <a className="block px-3 py-2 hover:bg-zinc-800 rounded-md">Contact</a>
                            </li>
                        </ul>
                    </details>
                </li>
